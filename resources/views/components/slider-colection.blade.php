<div x-data="{swiper: null}" x-init="swiper = new Swiper($refs.container, {
    ...
    <div class="absolute inset-y-0 left-0 z-10 flex items-center">
      ...
      <div @click="swiper.slidePrev()" class="swiper-button-prev" id="swiper-button-prev"></div>
    </div>

    <div class="swiper-container" id="swiper-container" x-ref="container">
    ...
    <div class="absolute inset-y-0 right-0 z-10 flex items-center">
      ...
      <div @click="swiper.slideNext()" class="swiper-button-next" id="swiper-button-next"></div>
    </div>
  </div>
  <script>
var mySwiperf = new Swiper('#swiper-container', {
  // Opciones de Swiper:
  navigation: {
  ...
  autoplay: {
    delay: 3000, // Aumenta el valor de delay a 5000 milisegundos (5 segundos)
    disableOnInteraction: false, // El autoplay no se detendrá cuando el usuario interactúa con el slider
  },
  slidesPerView: 'auto', // Ajusta el número de diapositivas visibles en función del ancho del contenedor
});
</script>